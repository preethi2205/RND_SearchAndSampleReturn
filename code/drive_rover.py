...
class RoverState():
    def __init__(self):
        ...
        self.rock_dist = None;
        self.new_perc_mapped = 6; # Percentage mapped
        self.old_perc_mapped = 0;
        self.map_time = 0;
        self.Is_Stuck = 0;
        self.SteerVel = np.zeros(10);
        self.Last_Known_Rock_x = 0;
        self.Last_Known_Rock_y = 0;
        self.Ok_To_Map = 1;
        self.StuckSteering = 0;
        self.StuckThrottle = 0;
